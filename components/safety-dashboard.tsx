    ...
    return (
        ...
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              Overall safety rating for {data.location}
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <TabsContent value="health" className="space-y-4 mt-6">
          <Alert>
            ...
            <AlertDescription>
              Current health advisories for {data.location}
            </AlertDescription>
          </Alert>
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold">
                      {data.emergencyContacts.fireService}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Emergency Hotline:</span>
                    <span className="font-bold">
                      {data.emergencyContacts.emergencyHotline}
                    </span>
                  </div>
                </div>
              </CardContent>
